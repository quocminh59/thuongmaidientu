...
Route::group(['prefix' => 'payment'], function() {
    ...
    Route::get('/{token}/{paymentType}/{orderId}', 'PayController@index')->name('index.payment');
    Route::post('/post-payment', 'PayController@postPayment')->name('post.payment');
    Route::post('/create-payment', 'PayController@createPayment')->name('create.payment');
    Route::get('/{a?}', 'PayController@return')->name('return.payment');
});
