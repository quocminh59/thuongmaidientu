        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <button type="submit" class="btn btn-primary" id="btnPopup">Tiếp tục thanh toán</button>
                    <button type="submit" name="redirect" id="redirect" class="btn btn-default">Quay trở lại</button>
